...
<head>
  ...
  <title>Famous Lahthi – Contact Us</title>
  
  <!-- Google Fonts Import for a traditional yet modern look -->
  <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;700&family=Inter:wght@300;400;600&display=swap" rel="stylesheet">

  <!-- Embedded CSS for Traditional Theme -->
  <style>
    /* Basic Reset & Body Styling */
    body {
      margin: 0;
      padding: 0;
      font-family: 'Inter', sans-serif; /* Modern, readable font for body text */
      background: linear-gradient(135deg, #fdfbfb 0%, #ebedee 100%); /* Subtle gradient background */
      color: #333;
      line-height: 1.6;
      display: flex; /* Use flexbox to center content */
      justify-content: center; /* Center horizontally */
      align-items: flex-start; /* Align to top, allowing content to flow naturally */
    ...
    header {
      ...
      margin-bottom: 30px;
      padding-bottom: 20px;
      border-bottom: 2px solid #f0e6d2; /* Subtle golden border */
    }

    header h1 {
      font-family: 'Playfair Display', serif; /* Elegant font for headings */
      font-size: 2.8em;
      color: #8B4513; /* Saddle Brown - a rich, traditional color */
      margin-bottom: 10px;
      letter-spacing: 1px;
    }
...
<body>
  <!-- Main container for the form and footer -->
  <div class="form-container">
    ...
    <section class="form-section">
      ...
      <form id="contactForm">
        ...
        <!-- Preferred Color Dropdown Field -->
        <div class="form-group">
  ...
  <!-- Link to your JavaScript file for form handling -->
